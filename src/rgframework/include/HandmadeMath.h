...
#define HMM_SQUARE(x) ((x) * (x))
    ...
    static inline HMM_Mat4 _HMM_PoseAt(HMM_Vec3 F, HMM_Vec3 S, HMM_Vec3 U, HMM_Vec3 Position)
    {
        HMM_Mat4 Result;

        Result.Elements[0][0] = -S.X;
        Result.Elements[0][1] = -S.Y;
        Result.Elements[0][2] = -S.Z;
        Result.Elements[0][3] = 0.0f;

        Result.Elements[1][0] = U.X;
        Result.Elements[1][1] = U.Y;
        Result.Elements[1][2] = U.Z;
        Result.Elements[1][3] = 0.0f;

        Result.Elements[2][0] = F.X;
        Result.Elements[2][1] = F.Y;
        Result.Elements[2][2] = F.Z;
        Result.Elements[2][3] = 0.0f;
    ...
    COVERAGE(HMM_PoseAt_LH, 1)
        static inline HMM_Mat4 HMM_PoseAt_LH(HMM_Vec3 Position, HMM_Vec3 Forward, HMM_Vec3 Up)
    {
        ASSERT_COVERED(HMM_PoseAt_LH);

        HMM_Vec3 F = Forward;
        HMM_Vec3 S = HMM_NormV3(HMM_Cross(F, Up));
        HMM_Vec3 U = HMM_Cross(S, F);

        return _HMM_PoseAt(F, S, U, Position);
    }
